...
└── users/
    ...
    │   ├── books/
    │   │   ├── the-great-gatsby_1234567890_abc123.epub
    │   │   └── tender-is-the-night_1234567891_def456.epub
    │   └── covers/
    │       ├── the-great-gatsby_1234567890_xyz789.jpg
    │       └── tender-is-the-night_1234567891_uvw012.jpg
    ├── 660e8400-e29b-41d4-a716-446655440001/
    │   ├── books/
    │   │   └── harry-potter_1234567892_ghi789.epub
    │   └── covers/
    │       └── harry-potter_1234567892_jkl012.jpg
    └── 770e8400-e29b-41d4-a716-446655440002/
        ├── books/
        │   └── game-of-thrones_1234567893_mno345.epub
        └── covers/
            └── game-of-thrones_1234567893_pqr678.jpg
```
...
1. ✅ S3 bucket created
2. ✅ IAM user and access keys configured
3. ✅ Environment variables set
4. ✅ Test upload endpoint
5. 🔄 (Optional) Set up CloudFront CDN for better performance
6. 🔄 (Optional) Set up S3 lifecycle policies for old files
7. 🔄 (Optional) Enable S3 versioning for backup
